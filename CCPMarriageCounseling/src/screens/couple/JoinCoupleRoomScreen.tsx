...
const JoinCoupleRoomScreen = () => {
  ...
  // Lấy mã từ QRScannerScreen nếu có
          ...
          <View className="mb-4">
            ...
            <View className="flex-row">
              ...
              <TouchableOpacity
                ...
                className="ml-3 rounded-xl px-4 py-4 items-center justify-center bg-success"
              >
                <Text className="text-white font-bold">Quét QR</Text>
              </TouchableOpacity>
            </View>
            {error ? (
