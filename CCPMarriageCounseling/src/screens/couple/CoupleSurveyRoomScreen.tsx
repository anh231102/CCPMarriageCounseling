...
const CoupleSurveyRoomScreen = () => {
    ...
    const isUserHost = user?.id === host?.accountId
        ...
        <View className="flex-1 bg-gray-50">
            <ScrollView className="flex-1 px-4 -mt-4" showsVerticalScrollIndicator={false}>
                ...
                {["host", "partner"].map((role) => {
                    ...
                    return (
                        <View key={role} className={`bg-white rounded-xl p-6 mb-4 shadow-sm border-l-4 ${isHost ? "border-primary" : "border-secondary"}`}>
                ...
                <View className="mb-8">
                    <TouchableOpacity
                        ...
                        className={`rounded-xl p-6 items-center shadow-sm ${userSurveyStatus !== "none" && partnerSurveyStatus === "completed" && !isCreatingLoveMap
                    ...
                    >
                        ...
                        <Text
                            className={`text-xl font-bold ${userSurveyStatus !== "none" && partnerSurveyStatus === "completed" && !isCreatingLoveMap
                                ? "text-white"
                                : "text-gray-500"
                                }`}
                        >
                        ...
                        <Text
                            className={`text-sm text-center mt-1 ${userSurveyStatus !== "none" && partnerSurveyStatus === "completed" && !isCreatingLoveMap
                                ? "text-white/80"
                                : "text-gray-400"
                                }`}
                        >
